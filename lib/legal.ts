...
export const LEGAL_DOCUMENTS = [
  {
    ...
    description:
      "Порядок обработки и защиты персональных данных пользователей сайта flextatic.ru.",
  },
  {
    slug: "personal-data-consent",
    label: "Согласие на обработку персональных данных",
    description:
      "Условия согласия на обработку персональных данных, предоставляемого при отправке формы на сайте flextatic.ru.",
  },
  {
    slug: "public-offer",
    label: "Договор-оферта",
    description:
      "Публичная оферта на оказание услуг по проведению танцевальных мастер-классов FLEXTATIC.",
  },
  {
    slug: "disclaimer",
    label: "Отказ от ответственности",
    description:
      "Особенности участия в танцевальных мастер-классах FLEXTATIC и использования сайта flextatic.ru.",
  },
] as const;
