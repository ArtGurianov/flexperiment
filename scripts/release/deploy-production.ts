/**
 * The production entry point the deploy workflow calls.
 *
...
process.stderr.write("RELEASE_PRODUCTION_ADAPTERS_UNAVAILABLE: production deploy adapters are materialized with the launch baseline; " +
