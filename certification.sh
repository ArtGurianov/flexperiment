...
EXPECTED_LEGAL_VERSION="${EXPECTED_LEGAL_VERSION:-2026-08-25.1}"
...
EXPECTED_PRIVACY_POLICY_SHA256="${EXPECTED_PRIVACY_POLICY_SHA256:-32c3a6c2664e5941118b36eab13a728851a8df93c7f93bbf5bec76db91794494}"
EXPECTED_PD_CONSENT_SHA256="${EXPECTED_PD_CONSENT_SHA256:-6084934c08c8ba0cda220c49d347afb81bada6307ae0763c0eb19b3d658a2035}"
