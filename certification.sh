...
EXPECTED_MIGRATION="${EXPECTED_MIGRATION:-0034_worker_sweep_evidence.sql}"
EXPECTED_LEGAL_VERSION="${EXPECTED_LEGAL_VERSION:-2026-08-28.1}"
EXPECTED_LEGAL_RELEASE_ID="${EXPECTED_LEGAL_RELEASE_ID:-}"
EXPECTED_PUBLIC_OFFER_SHA256="${EXPECTED_PUBLIC_OFFER_SHA256:-bd20b056a269ed1286c6ea35a728fbfd58e90a2f845b72ac112fe3544ec9ecaf}"
EXPECTED_PRIVACY_POLICY_SHA256="${EXPECTED_PRIVACY_POLICY_SHA256:-642d11458733e8c1e5bfb28d0cde7f917a276dfcb3e32dc52adc34fac6326339}"
EXPECTED_PD_CONSENT_SHA256="${EXPECTED_PD_CONSENT_SHA256:-acdb8a31a846c1c697cfd977fb67f24e75d280ab72cb6fbce5bbf0146d4ba5b6}"
EXPECTED_CHECKOUT_DISCLOSURE_SHA256="${EXPECTED_CHECKOUT_DISCLOSURE_SHA256:-97f84fb7d8af72964e4c24f93223a99daf53002f7542cb9209608d1e5335902f}"
CITY_SLUG="kemerovo"
