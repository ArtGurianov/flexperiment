...
EXPECTED_LEGAL_VERSION="${EXPECTED_LEGAL_VERSION:-2026-08-26.1}"
...
EXPECTED_PRIVACY_POLICY_SHA256="${EXPECTED_PRIVACY_POLICY_SHA256:-28f6d08d7ccf8ccf03a7eef751e845e314bb16718347e4b907cdce6341e0f3e4}"
EXPECTED_PD_CONSENT_SHA256="${EXPECTED_PD_CONSENT_SHA256:-38bf1a63198cd4b9dd326c24d5244eec7dc36a7da4b43ca366e81926e224db80}"
