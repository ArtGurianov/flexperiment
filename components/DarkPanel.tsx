...
export const DARK_PANEL_SURFACE =
  "bg-[rgb(22_20_18_/_0.5)] shadow-[-10px_10px_24px_rgb(202_255_86_/_0.3),-16px_16px_48px_rgb(202_255_86_/_0.18)]";

export default function DarkPanel({
  className = "",
  ...props
}: ComponentPropsWithoutRef<"div">) {
  return <div className={`${DARK_PANEL_SURFACE} ${className}`} {...props} />;
}
