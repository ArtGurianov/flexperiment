...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Нет. Вопреки распространенному мнению, заломы рук - совсем не обязательная часть флексинга. Мы работаем прежде всего с контролем тела, изоляциями и координацией. Все упражнения можно выполнять в комфортной для себя амплитуде.",
  },
  {
