...
describe("0048 ord_reporting migration", () => {
  ...
  describe("PR3-PR7's required-schema-object list now also proves PR8's authority/evidence objects", () => {
    const pr8Objects = [
      ...
      "ord_provider_operations_correction_only_guard", "ord_provider_operations_authority_immutable_guard", "ord_provider_operations_observed_id_immutable_guard",
      "ord_provider_operations_lock_requires_current_guard", "ord_provider_operations_delete_guard",
      ...
      "ord_creative_registrations_correction_only_guard", "ord_creative_registrations_authority_immutable_guard", "ord_creative_registrations_observed_ids_immutable_guard",
      "ord_creative_registrations_lock_requires_current_guard", "ord_creative_registrations_delete_guard",
