...
const [statusPath, completionPath, requestPath, candidateSourceCommit, previousLegalVersion = "2026-08-23.2"] = process.argv.slice(2);
...
console.log(JSON.stringify(reconcileCutover({ request, candidateSourceCommit, status: statusPayload, runtime: statusPayload.runtime, completion, previousLegalVersion })));
