...
## Post-purchase occurrence changes

Occurrence editing is optimistic: `PATCH /v1/admin/occurrences/:id` carries
the currently read `expected_revision`. A stale editor receives
`OCCURRENCE_REVISION_CONFLICT`; reload before making a new decision.
